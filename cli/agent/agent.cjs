...
// Transitional imports: core model routing now via ../core barrel; codegen/multiedit still from ../../lib until moved.
const { chatCompletion, getModelDefaults, detectTaskType } = require('../core/index.cjs');
const { generateCode, generateFunction, saveCodeToFile } = require('../../cli/code/codegen.cjs');
